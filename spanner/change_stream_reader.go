...
type ChangeStreamReaderConfig struct {
...
func NewChangeStreamReader(ctx context.Context, dbPath, streamID string) (*ChangeStreamReader, error) {
	return NewChangeStreamReaderWithConfig(ctx, dbPath, streamID, ChangeStreamReaderConfig{
		SpannerClientConfig: spanner.ClientConfig{
...
func NewChangeStreamReaderWithConfig(ctx context.Context, dbPath, streamID string, config ChangeStreamReaderConfig) (*ChangeStreamReader, error) {
...
func (r *ChangeStreamReader) Close() {
	r.client.Close()
}
...
func (r *ChangeStreamReader) Read(ctx context.Context, f func(context.Context, *ReadResult) error) error {
	r.mu.Lock()
	if r.group != nil {
		r.mu.Unlock()
...
func (r *ChangeStreamReader) startRead(ctx context.Context, partitionToken string, startTimestamp time.Time, f func(context.Context, *ReadResult) error) error {
...
func (r *ChangeStreamReader) markStateReading(partitionToken string) bool {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *ChangeStreamReader) markStateFinished(partitionToken string) {
	r.mu.Lock()
	defer r.mu.Unlock()
...
func (r *ChangeStreamReader) canReadChild(partition *ChildPartition) bool {
	r.mu.Lock()
	defer r.mu.Unlock()
